        ...
        <div className='container'>
            ...
            md:overflow-hidden max-md:flex-col feature-after md:g7 max-md:border-none max-md:rounded-none max-md:gap-3'>
                {features.map((feature) => (
                    <div key={feature.id} className='relative z-2 md:px-10 px-5 md:pb-10 pb-5 flex-50 max-md:g7 
                    ...
                    {details.map((detail) => (
                        <li key={detail.id} className='relative pt-16 px-4 pb-14'>
                            ...
                            hover:border-s4 transition-all duration-500 shadow-500 size-20'>
                                <img src={detail.icon} alt={detail.title} className='size-17/2- object-contain z-20' />
                            </div>
