...
const Header = () => {
    ...
    return (
        <header className={clsx("fixed top-0 left-0 z-50 w-full py-10 translate-all duration-500 max-lg:py-4", 
        hasScrolled && 'py-2 bg-black-100 backdrop-blur-[8px]')}>
            <div className="container flex h-14 items-center max-lg:px-5">
                ...
                <button className="lg:hidden z-2 size-10 border-2 border-s4/25 rounded-full flex 
