...
const TestimonialItem = ({ item, containerClassName }) => {
  return (
    <div className={clsx("relative px-14 pt-11 pb-14 after:absolute after:bottom-0 after:right-0 after:h-05 after:w-screen after:bg-s2 after:content-[''] max=md:px-0 max-md:pt-11 after:max-md:-right-4",
        containerClassName
    )}>
        ...
        <div className="flex items-center max-xl:-mr-8">
            <div className="mr-4 size-20 shrink-0 rounded-half border-2 border-s2 p-1.5">
                <img src={item.avatarUrl} alt={item.name} className="sizee-full object-cover"/>
            </div>
            <div>
